  ...
  return (
    <>
      ...
      <div className="container">
        <h1 className="text-xl font-bold mt-4 ml-8">ADD NEW ROOM TYPE</h1>
        <div className="flex flex-col md:flex-row gap-24 mt-6">
          <div className="flex-1">
            ...
            >
              ...
              <button
                type="submit"
                className="absolute bottom-8  bg-orange-950 hover:bg-yellow-600 text-white font-bold py-2 px-4 border  rounded w-60"
              >
                ADD ROOM
              </button>
            </form>
