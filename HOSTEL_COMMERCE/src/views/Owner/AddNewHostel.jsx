  ...
  return (
    <div className="container">
      ...
      <div className="flex flex-col md:flex-row gap-24 mt-8">
        <div className="flex-1">
            <form className="space-y-4 mt-0 ml-44 w-3/4 h-screen">
                <div className="">
    ...
    <div className="mt-1 h-screen flex-1 space-y-6 relative">
      ...
      <div className="bg-black">
        <button className= "absolute bottom-5 right-0 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded w-60">
            ADD HOSTEL
        </button>
      </div>
    </div>
